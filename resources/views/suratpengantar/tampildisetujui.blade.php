...
<title>Pendataan Penduduk</title>
    <h1 class="text-center mb-4">Pengajuan Surat Pengantar</h1>
        <div class="row justify-content-md-center">
          <div class="container">
            <a href="/tambahsuratpengantar" type="button" class="btn btn-danger" style="background-color: #2b93de">Tambah +</a><br>
            <br>
                    ...
                    <tr>
                      ...
                      <td>{{ $row->nik }}</td>
                        ...
                        <td>
                          ...
                          <a href="/tampildisetujui{{ $row->id }}" class="btn btn-secondary">Disetujui</i></a>
                          <a href="/#/{{ $row->id }}" class="btn btn-danger">Ditolak</i></a>
                          <a href="/#/{{ $row->id }}" class="btn btn-primary"><i class="fa-solid fa-print"></i> cetak</i></a>
