...
@section('content')
    ...
    <h1 class="text-center mb-4">Edit Data Iuran Bulanan</h1>
      <div class="container">
        <div class="row justify-content-center">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
                        <form action="/updateiuranbulanan/{{ $data->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Id Iuran Bulanan</label>
                              <input type="text" name="id_iuran_bulanan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->id_iuran_bulanan }}">
                            </div>
                            <div class="mb-3">
                            ...
                            {{-- <div class="mb-3">
                              ...
                              <input type="time" name="waktu_bayar" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->tanggal_bayar }}">
                            </div> --}}
                            <div class="form-group">
