...
<title>Pendataan Penduduk</title>
  ...
  <body>
    ...
    <div class="container">
      @can ('bendahara')
        <a href="/tambahiuranbulanan" type="button" class="btn btn-danger"  style="background-color: #183cc0">Tambah+</a>
		<br><br>
        @endcan
			...
			<div class="card p-4 m-4">
				<div class="row justify-content-center">
					...
					<div class="card px-6 py-6">
						<form action="/iuranbulanan/" method="GET">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-center">
              <table class="table" id="iuran_bulanans" class="display">
                  <thead> 
                      <tr>
                        <th scope="col">#</th>
                        <th scope="col">NIK</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              @can('bendahara')
                                <a href="/tampiliuranbulanan/{{ $row->id }}" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                @endcan
