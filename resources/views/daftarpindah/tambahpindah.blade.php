          ...
          <div class="mb-3">
            ...
            <select class="form-control" >
                ...
                @foreach ($data as $item)
                  <option value="{{ $item->no_kk }}" {{ ( $item->no_kk) ? 'selected' : '' }}> {{ $item->no_kk }} </option>
                @endforeach
              </select>
          </div>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">NIK</label>
            <input type="text" name ="nik" class="form-control" value="{{$perpindahan->nik}}" disabled id="exampleInputEmail1">
            <input type="text" name ="nik" class="form-control" value="{{$perpindahan->nik}}" style="display: none" id="exampleInputEmail1">
          </div>  
          <div class="mb-3">
