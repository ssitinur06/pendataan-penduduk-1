      ...
      <div class="card-body">
        <form action="/insertpenduduk" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" name ="nik" class="form-control" value="{{$kelahiran->nik}}" disabled id="exampleInputEmail1">
            <input type="text" name ="nik" class="form-control" value="{{$kelahiran->nik}}" style="display: none" id="exampleInputEmail1">
          </div>  
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">No KK</label>
            <input type="text" name ="no_kk" class="form-control" value="{{$kelahiran->no_kk}}" disabled id="exampleInputEmail1">
            <input type="text" name ="no_kk" class="form-control" value="{{$kelahiran->no_kk}}" style="display: none" id="exampleInputEmail1">
          </div>
          <div class="mb-3">
